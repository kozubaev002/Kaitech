...
const texts = [
    ...
    "Avenir — это образовательное учреждение в Бишкеке. Avenir College предоставляет профессиональное образование в сферах IT, бизнеса и педагогики.",
    "NSR Construction — современная строительная компания в Кыргызстане, занимающаяся возведением жилых и коммерческих объектов, а также инфраструктурных проектов."
];
